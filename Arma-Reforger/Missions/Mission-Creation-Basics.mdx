---
title: "Mission Creation Basics in Arma Reforger"
description: "Learn the fundamentals of creating missions in Arma Reforger using the mission editor."
icon: "map-marked-alt"
---

# Mission Creation Basics in Arma Reforger  

Creating missions is one of the most exciting aspects of Arma Reforger. The mission editor allows you to design custom scenarios, objectives, and environments for players. This guide will walk you through the basics of mission creation.

<Callout type="info">  
This guide assumes you’ve already set up your server or game client. If not, refer to our [Basic Setup Guide](/getting-started/basic-setup).  
</Callout>  
...
## Steps to Create a Basic Mission  
